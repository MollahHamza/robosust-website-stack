...
def seed_data():
    ...
    achievements_data = [
        {
            ...
            'description': 'Team EcoQuest secured notable position in NASA Space Apps Challenge with innovative environmental monitoring solution.',
            'image': '/assets/images/work/NasaSpaceApp.jpg'
        },
        {
            'title': 'BUET Chemical Fest 2024',
            'description': 'Team ঘোড়ার গাড়ি showcased exceptional performance in the ChemiCar segment at BUET Chemical Fest 2024.',
            'image': '/assets/images/work/Ghorar_gari.jpg'
        },
        {
            'title': 'Smart Unibator Innovation Hub',
            'description': 'Team Automama represented SUST at the Smart Unibator Innovation Hub program with their autonomous vehicle project.',
            'image': '/assets/images/work/Unovationhub_1.jpg'
        },
        {
            'title': 'KUET LFR Contest',
            'description': 'Team Void Sust achieved remarkable success in the KUET Calibration LFR Contest.',
            'image': '/assets/images/work/KUET-1.jpg'
        },
        {
            'title': 'BRAC IEEE Satellite Expedition',
            'description': 'Team Ethereal Luminary participated in BRAC University IEEE Satellite Expedition competition.',
            'image': '/assets/images/work/Comsot.jpg'
        },
        {
            'title': 'KUET LFR Champion',
            'description': 'Team SUST Mavericks emerged as champions in the Line Follower Robot segment at KUET Ignition.',
            'image': '/assets/images/work/KUET-2.jpg'
        }
    ]

    for i, data in enumerate(achievements_data):
        if not Achievement.query.filter_by(title=data['title']).first():
            achievement = Achievement(order=i, **data)
            db.session.add(achievement)
    ...
    initiatives_data = [
        {
            'title': 'Automama',
            'description': "Bangladesh's first Level 2 autonomous car project. Featuring advanced driver assistance systems including lane keeping, adaptive cruise control, and collision avoidance.",
            'image': '/assets/images/home/automama.png',
            'status': 'ongoing'
        },
        {
            'title': 'Orca',
            'description': 'Autonomous Underwater Vehicle (AUV) designed for underwater exploration and research. Equipped with sonar, cameras, and advanced navigation systems.',
            'image': '/assets/images/home/orca.png',
            'status': 'ongoing'
        },
        {
            'title': 'ChemiCar',
            'description': 'A custom battery powered car with color sensor based stopping mechanism. Designed for precision movement and chemical energy conversion.',
            'image': '/assets/images/home/chemicar.png',
            'status': 'ongoing'
        }
    ]
    ...
    for i, data in enumerate(initiatives_data):
        if not Initiative.query.filter_by(title=data['title']).first():
            initiative = Initiative(order=i, **data)
            db.session.add(initiative)
    ...
    for i, data in enumerate(workshops_data):
        if not Workshop.query.filter_by(title=data['title']).first():
            workshop = Workshop(order=i, **data)
            db.session.add(workshop)
    ...
    projects_data = [
        {
            ...
            'description': 'An IoT-based system that recognizes sign language gestures and converts them to text and speech, enabling better communication for the hearing impaired.',
            'image': '/assets/images/project/1.jpg',
            'status': 'completed'
        },
        {
            'title': 'Autonomous Water Vehicle',
            'description': 'A self-navigating water vehicle with advanced collision avoidance capabilities, designed for environmental monitoring and water quality assessment.',
            'image': '/assets/images/project/2.jpg',
            'status': 'ongoing'
        },
        {
            'title': 'Ribo - Social Humanoid Robot',
            'description': "Bangladesh's first social humanoid robot that can speak Bengali. Created to interact with humans in a natural and engaging way.",
